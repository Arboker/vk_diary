                        ...
                        <div>
                            ...
                            <div style={{
                                ...
                                <Text style={{
                                    ...
                                    color: "white", textAlign: "center", marginTop: 40,
                            ...
                            <div style={{
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    style={{ background: this.props.theme == "space_gray" ? "#2b7ede" : "rgb(70, 145, 230)" }}
                                    version="1.1" viewBox="0 0 1440 320" width="100%">
                                    <path
                                        // fill={this.props.theme == "space_gray" ? "#2b7ede" : "rgb(70, 145, 230)"}
                                        fill="var(--background_content)"
                                        style={{ width: "100%" }}
                                        fillOpacity="1"
                                        // d="M0,96L48,106.7C96,117,192,139,288,144C384,149,480,139,576,133.3C672,128,768,128,864,138.7C960,149,1056,171,1152,165.3C1248,160,1344,128,1392,112L1440,96L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
                                        d="M0,128L48,138.7C96,149,192,171,288,170.7C384,171,480,149,576,144C672,139,768,149,864,144C960,139,1056,117,1152,117.3C1248,117,1344,139,1392,149.3L1440,160L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
                                    ></path>
                                </svg>
                            </div>
                        </div>
